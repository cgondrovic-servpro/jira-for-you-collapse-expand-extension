class JiraSwimlaneCollapser {
  ...
  addPriorityIcons(section) {
    ...
    items.forEach((item) => {
      ...
      // Margin + gap: Jira styles can override gap alone; !important inline wins their CSS
      ...
      // Ensure the parent container displays children inline (Jira often fixes chip width for one icon)
